...
| `TASK-23-AGENT_FRONTEND.md` | App shell | merged PR #14 |
| `TASK-24-AGENT_FRONTEND.md` | Daily slate page | merged PR #15 |
| `TASK-25-AGENT_FRONTEND.md` | Game detail | **in progress** |
| `TASK-26-AGENT_DESIGN.md` | UX/visual spec | merged PR #11 |
| `TASK-27-AGENT_CONTENT.md` | Methodology + trust | merged PR #10 |
| `TASK-28-AGENT_INFRA.md` | Docker + Fly scaffold | **in progress** |
| `TASK-29-AGENT_INFRA.md` | GHA data refresh cron | after TASK-28 |
| `TASK-30-AGENT_INFRA.md` | Vercel + Fly deploy | **in progress** |
